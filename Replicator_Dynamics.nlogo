...
breed [turtlesA turtleA]
breed [turtlesB turtleB]

to setup
  clear-all
  create-turtlesA number-A [
    set color 15
    setxy random-xcor random-ycor
  ]
    create-turtlesB number-B [
    set color 65
    setxy random-xcor random-ycor
  ]
...
to death
  ...
  ask turtles [
    if random total-turtles > (number-A + number-B) [
      die
    ]
  ]
end
...
to calculate-score
  if outcome = "dominance" [
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesB) [ set score 1 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 2 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 1 ]
  ]
  if outcome = "bistability" [
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesA) [ set score 2 ]
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesB) [ set score 1 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 2 ]
  ]
  if outcome = "coexistence" [
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesB) [ set score 2 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 2 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 1 ]
  ]
  if outcome = "neutrality" [
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesB) [ set score 1 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 1 ]
...
outcome
outcome
"dominance" "bistability" "coexistence" "neutrality"
0
