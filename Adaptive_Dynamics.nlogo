...
to go
  if (variance [color] of turtles = 0) and (can-stop?) [
    stop
  ]
  clear-last-round
  ask turtles [
...
to add-invader
  set number-B (number-A * percentage-B)
...
to calculate-score
  if outcome = "dominance" [
    ...
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 0 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 1 ]
  ]
  if outcome = "bistability" [
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesA) [ set score 1 ]
    if ([breed] of self = turtlesA) and ([breed] of partner = turtlesB) [ set score 0 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesA) [ set score 0 ]
    if ([breed] of self = turtlesB) and ([breed] of partner = turtlesB) [ set score 1 ]
  ]
...
outcome
outcome
"dominance" "bistability" "coexistence"
0
